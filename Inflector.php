...
class Inflector {
  ...
  private static $singular = array(
    ...
    array('/^(a)x[ie]s$/i', '$1xis'),
    array('/(cris|test)(is|es)$/i', '$1is'),
    array('/(shoe)s$/i', '$1'),
    array('/(o)es$/i', '$1'),
    array('/(bus)(es)?$/i', '$1'),
    ...
    array('/(hive)s$/i', '$1'),
    array('/([^f])ves$/i', '$1fe'),
    array('/(^analy)(sis|ses)$/i', '$1sis'),
    array('/((a)naly|(b)a|(d)iagno|(p)arenthe|(p)rogno|(s)ynop|(t)he)(sis|ses)$/i', '$1sis'),
    array('/([ti])a$/i', '$1um'),
    array('/(n)ews$/i', '$1ews'),
    array('/(ss)$/i', '$1'),
    array('/s$/i', '')
  ...
  public static function camelize($lowercase_and_underscored_word, $first_letter_uppercase = true) {
    if ($first_letter_uppercase) {
      return preg_replace_callback('/(^|_)(.)/', function($m) { return strtoupper($m[2]); }, preg_replace_callback('/\/(.?)/', function($m) { return '::' . strtoupper($m[1]); }, $lowercase_and_underscored_word));
    } else {
  ...
  public static function parameterize($string, $separator = '-') {
